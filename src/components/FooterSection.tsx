...
const socials = [
  ...
  {
    name: "Instagram",
    url: "https://instagram.com/mohid.qx/",
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-10 items-start">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="font-mono-terminal text-[10px] text-muted-foreground mt-0.5">Monitor and Protect</p>
            </div>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-border/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="font-mono-terminal text-[10px] text-muted-foreground/40">
            github.com/mohidqx • Offensive Security Research
          </p>
        </div>
      </div>
    </footer>
